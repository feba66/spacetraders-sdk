    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class data(
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["agent", "ship", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["agent", "ship", ], str]):
                    return super().get_item_oapg(name)
