# openapi_client.model.market_transaction.MarketTransaction
...
**tradeSymbol** | str,  | str,  | The symbol of the trade good. | [optional] 
**totalPrice** | decimal.Decimal, int,  | decimal.Decimal,  | The total price of the transaction. | [optional] 
